...
public class MovimientoController {
    ...
    public ResponseEntity<ApiResponse<String>> getByCliente(@PathVariable Integer idMovimiento) {
    ...
    @PostMapping("/save")
    public ResponseEntity<ApiResponse<String>> save(@RequestBody MovimientosEntity Movimiento) {
        return new ResponseEntity<>(movimientoService.save(Movimiento), HttpStatus.OK);
    }

    @PatchMapping("/update")
    public ResponseEntity<ApiResponse<String>> update(@RequestBody MovimientosEntity movimiento) {
