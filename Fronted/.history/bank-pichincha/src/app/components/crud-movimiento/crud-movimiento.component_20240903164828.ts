...
export class dialogOpciones {
  constructor(@Inject(MAT_DIALOG_DATA) public data: { listaMovimiento: MovimientoModel[], listCotMarcaModel: cotMarcaModel[] },
  private formBuilder: FormBuilder
  private dialogRef: MatDialogRef<dialogEditarOrdenDetalleEquipo>, private toast: ToastrService,
  private filtroAutoCompleteService: AutoCompleteFiltroCotizacionService,
